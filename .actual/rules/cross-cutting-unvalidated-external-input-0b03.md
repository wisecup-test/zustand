...
- **R-UNVAL-001** MUST NOT: Unvalidated external input MUST NOT be directly used in security-sensitive operations such as file system access, command execution, or database queries.

### Verify

```bash
# Count unvalidated process.env access
