...
1. MUST: The testing framework MUST support TypeScript, React Testing Library, and JSX/TSX syntax without additional transpilation configuration

## Policy Block

- MUST The testing framework MUST support TypeScript, React Testing Library, and JSX/TSX syntax without additional transpilation configuration
