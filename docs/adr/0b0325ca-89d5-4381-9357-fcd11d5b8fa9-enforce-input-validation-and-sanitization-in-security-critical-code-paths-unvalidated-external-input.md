# Enforce Input Validation and Sanitization in Security-Critical Code Paths: Unvalidated External Input
...
1. MUST_NOT: Unvalidated external input MUST NOT be directly used in security-sensitive operations such as file system access, command execution, or database queries

## Policy Block

- MUST_NOT Unvalidated external input MUST NOT be directly used in security-sensitive operations such as file system access, command execution, or database queries
