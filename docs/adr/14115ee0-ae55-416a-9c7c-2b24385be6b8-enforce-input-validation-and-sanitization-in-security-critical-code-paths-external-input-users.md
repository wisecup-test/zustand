...
1. MUST: All external input from users, configuration files, network requests, or environment variables MUST be validated before processing

## Policy Block

- MUST All external input from users, configuration files, network requests, or environment variables MUST be validated before processing
