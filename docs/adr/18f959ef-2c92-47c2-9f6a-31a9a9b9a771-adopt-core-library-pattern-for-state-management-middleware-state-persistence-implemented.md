...
1. SHOULD: State persistence SHOULD be implemented using the persist middleware with configurable storage backends

## Policy Block

- SHOULD State persistence SHOULD be implemented using the persist middleware with configurable storage backends
