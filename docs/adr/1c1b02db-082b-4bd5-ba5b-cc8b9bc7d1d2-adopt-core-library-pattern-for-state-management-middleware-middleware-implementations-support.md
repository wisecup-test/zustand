...
1. MUST: All middleware implementations MUST support both vanilla JavaScript and React usage patterns

## Policy Block

- MUST All middleware implementations MUST support both vanilla JavaScript and React usage patterns
