...
1. MUST: Public APIs MUST expose a middleware composition mechanism that allows consumers to intercept and augment core functionality

## Policy Block

- MUST Public APIs MUST expose a middleware composition mechanism that allows consumers to intercept and augment core functionality
