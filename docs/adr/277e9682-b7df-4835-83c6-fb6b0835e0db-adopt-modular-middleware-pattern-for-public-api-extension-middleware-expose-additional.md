...
1. MAY: Middleware MAY expose additional utility functions or helpers specific to their domain (e.g., shallow comparison utilities)

## Policy Block

- MAY Middleware MAY expose additional utility functions or helpers specific to their domain (e.g., shallow comparison utilities)
