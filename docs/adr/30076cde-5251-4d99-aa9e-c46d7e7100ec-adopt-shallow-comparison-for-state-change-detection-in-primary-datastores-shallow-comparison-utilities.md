...
1. SHOULD: Shallow comparison utilities SHOULD be extracted into reusable functions to ensure consistent behavior across different datastore implementations

## Policy Block

- SHOULD Shallow comparison utilities SHOULD be extracted into reusable functions to ensure consistent behavior across different datastore implementations
