...
1. MAY: Message queues MAY implement priority handling or ordering guarantees based on middleware requirements

## Policy Block

- MAY Message queues MAY implement priority handling or ordering guarantees based on middleware requirements
