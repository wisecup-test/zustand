...
1. SHOULD: Core library SHOULD provide reference middleware implementations for common use cases (persistence, dev tools, framework integration)

## Policy Block

- SHOULD Core library SHOULD provide reference middleware implementations for common use cases (persistence, dev tools, framework integration)
