...
1. MUST_NOT: Shallow comparison MUST NOT be used as the sole mechanism when nested object mutations need to be detected without reference changes

## Policy Block

- MUST_NOT Shallow comparison MUST NOT be used as the sole mechanism when nested object mutations need to be detected without reference changes
