...
1. SHOULD: Middleware SHOULD follow a consistent signature pattern that accepts configuration and returns an enhanced API

## Policy Block

- SHOULD Middleware SHOULD follow a consistent signature pattern that accepts configuration and returns an enhanced API
