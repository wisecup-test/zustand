...
1. SHOULD: Tests SHOULD cover specialized React patterns including state management libraries (Immer), shallow comparison, and server-side rendering scenarios

## Policy Block

- SHOULD Tests SHOULD cover specialized React patterns including state management libraries (Immer), shallow comparison, and server-side rendering scenarios
