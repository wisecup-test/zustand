...
1. MUST: State objects MUST be treated as immutable, with mutations creating new object references to ensure shallow comparison correctness

## Policy Block

- MUST State objects MUST be treated as immutable, with mutations creating new object references to ensure shallow comparison correctness
