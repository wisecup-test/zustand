# Enforce Input Validation and Sanitization in Security-Critical Code Paths: Input Validation Occur
...
1. MUST: Input validation MUST occur at trust boundaries before data enters the application domain

## Policy Block

- MUST Input validation MUST occur at trust boundaries before data enters the application domain
