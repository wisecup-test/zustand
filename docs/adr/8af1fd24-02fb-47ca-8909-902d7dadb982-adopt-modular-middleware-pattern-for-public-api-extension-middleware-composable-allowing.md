...
1. SHOULD: Middleware SHOULD be composable, allowing multiple middleware to be chained without conflicts

## Policy Block

- SHOULD Middleware SHOULD be composable, allowing multiple middleware to be chained without conflicts
