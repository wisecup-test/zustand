...
1. SHOULD: Test suites SHOULD separate vanilla JavaScript logic tests from React component tests using directory structure

## Policy Block

- SHOULD Test suites SHOULD separate vanilla JavaScript logic tests from React component tests using directory structure
