...
1. SHOULD: Redux integration SHOULD be provided through the redux middleware for applications requiring Redux DevTools or Redux ecosystem compatibility

## Policy Block

- SHOULD Redux integration SHOULD be provided through the redux middleware for applications requiring Redux DevTools or Redux ecosystem compatibility
