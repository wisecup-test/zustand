# Adopt Message Queue Pattern for Middleware Communication: Middleware Components Communicate
...
1. MUST: Middleware components MUST communicate through message queue boundaries rather than direct method invocations

## Policy Block

- MUST Middleware components MUST communicate through message queue boundaries rather than direct method invocations
