...
1. SHOULD: Middleware SHOULD subscribe to specific message types or channels to receive relevant communications

## Policy Block

- SHOULD Middleware SHOULD subscribe to specific message types or channels to receive relevant communications
