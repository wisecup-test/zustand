...
1. SHOULD: Validation logic SHOULD use allowlists (permitted patterns) rather than denylists (blocked patterns) where feasible

## Policy Block

- SHOULD Validation logic SHOULD use allowlists (permitted patterns) rather than denylists (blocked patterns) where feasible
