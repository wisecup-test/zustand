...
1. MUST: All test files MUST use TypeScript with .test.ts or .test.tsx extensions

## Policy Block

- MUST All test files MUST use TypeScript with .test.ts or .test.tsx extensions
