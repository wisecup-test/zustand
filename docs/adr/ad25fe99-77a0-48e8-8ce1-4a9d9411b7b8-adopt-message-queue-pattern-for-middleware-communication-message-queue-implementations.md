...
1. MUST: Message queue implementations MUST support asynchronous message passing between middleware layers

## Policy Block

- MUST Message queue implementations MUST support asynchronous message passing between middleware layers
