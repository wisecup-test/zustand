# Enforce Input Validation and Sanitization in Security-Critical Code Paths: Input Sanitization Applied
...
1. SHOULD: Input sanitization SHOULD be applied to remove or escape potentially dangerous characters or patterns

## Policy Block

- SHOULD Input sanitization SHOULD be applied to remove or escape potentially dangerous characters or patterns
