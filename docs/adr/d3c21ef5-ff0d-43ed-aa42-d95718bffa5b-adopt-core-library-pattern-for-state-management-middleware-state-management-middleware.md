...
1. MUST: State management middleware MUST be implemented as composable, modular functions that can be combined using the combine middleware pattern

## Policy Block

- MUST State management middleware MUST be implemented as composable, modular functions that can be combined using the combine middleware pattern
