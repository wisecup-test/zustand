...
1. SHOULD: Datastores SHOULD provide configuration options to customize comparison behavior for specific use cases requiring deep equality

## Policy Block

- SHOULD Datastores SHOULD provide configuration options to customize comparison behavior for specific use cases requiring deep equality
