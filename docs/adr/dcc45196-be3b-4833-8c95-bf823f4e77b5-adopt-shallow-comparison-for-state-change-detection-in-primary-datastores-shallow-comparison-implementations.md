...
1. MUST: Shallow comparison implementations MUST check reference equality first before iterating over object properties for performance optimization

## Policy Block

- MUST Shallow comparison implementations MUST check reference equality first before iterating over object properties for performance optimization
