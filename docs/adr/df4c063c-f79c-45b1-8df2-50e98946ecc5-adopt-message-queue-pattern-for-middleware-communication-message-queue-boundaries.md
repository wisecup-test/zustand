# Adopt Message Queue Pattern for Middleware Communication: Message Queue Boundaries
...
1. SHOULD: Message queue boundaries SHOULD be testable in isolation without requiring full middleware stack initialization

## Policy Block

- SHOULD Message queue boundaries SHOULD be testable in isolation without requiring full middleware stack initialization
