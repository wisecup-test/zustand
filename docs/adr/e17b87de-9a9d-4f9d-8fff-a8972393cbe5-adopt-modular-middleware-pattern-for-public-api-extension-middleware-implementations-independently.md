# Adopt Modular Middleware Pattern for Public API Extension: Middleware Implementations Independently
...
1. MUST: Middleware implementations MUST be independently distributable as separate modules without requiring core library modifications

## Policy Block

- MUST Middleware implementations MUST be independently distributable as separate modules without requiring core library modifications
