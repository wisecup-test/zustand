...
1. MUST: Test files MUST be organized in a dedicated tests directory with subdirectories for different test contexts (e.g., vanilla, integration)

## Policy Block

- MUST Test files MUST be organized in a dedicated tests directory with subdirectories for different test contexts (e.g., vanilla, integration)
