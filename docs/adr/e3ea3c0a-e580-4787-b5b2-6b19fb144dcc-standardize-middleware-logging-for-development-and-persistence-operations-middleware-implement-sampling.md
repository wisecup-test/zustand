...
1. MAY: Middleware MAY implement sampling or rate-limiting for high-frequency operations to manage log volume

## Policy Block

- MAY Middleware MAY implement sampling or rate-limiting for high-frequency operations to manage log volume
