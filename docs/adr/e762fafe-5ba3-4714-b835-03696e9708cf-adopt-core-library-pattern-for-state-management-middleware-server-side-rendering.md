...
1. MUST: Server-side rendering scenarios MUST use the ssrSafe middleware to prevent hydration mismatches

## Policy Block

- MUST Server-side rendering scenarios MUST use the ssrSafe middleware to prevent hydration mismatches
