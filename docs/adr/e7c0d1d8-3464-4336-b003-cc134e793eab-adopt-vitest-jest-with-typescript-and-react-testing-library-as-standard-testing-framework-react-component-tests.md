...
1. MUST: React component tests MUST use the .test.tsx extension to support JSX syntax

## Policy Block

- MUST React component tests MUST use the .test.tsx extension to support JSX syntax
