...
1. SHOULD: Devtools and persistence middleware SHOULD use message queues for state synchronization and debugging communication

## Policy Block

- SHOULD Devtools and persistence middleware SHOULD use message queues for state synchronization and debugging communication
